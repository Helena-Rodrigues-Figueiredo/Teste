...
myWebpage.addEventListener("dblclick", outraPagina);

function outraPagina(outroEvento) {
  window.location.replace("https://helena-rodrigues-figueiredo.github.io/");
}

// 5. Crie uma função que, ao passar o mouse sobre 'Meu top 3 do Spotrybefy', altere
// a cor do mesmo;

myWebpage.addEventListener("mouseover", mudaDeCor);
myWebpage.addEventListener("mouseout", voltaACorNormal);
...
function voltaACorNormal(event) {
